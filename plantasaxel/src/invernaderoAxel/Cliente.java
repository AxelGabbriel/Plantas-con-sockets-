...
import chatcliente.hilodeenviar;
import chatcliente.HiloRecibir;
import invernaderoAxel.Cliente;
...
public class Cliente extends JFrame {
	 ...
	 public JTextField ingresoMensaje;
	    ...
	    private static String ipServidor;// = "192.168.1.112";
	...
	//Correr los hilos de enviar y recibir
	            hilodeenviar hiloEnviarCliente = new hilodeenviar(cliente, ventanaCliente);
